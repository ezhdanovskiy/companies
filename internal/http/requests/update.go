...
type UpdateCompany struct {
	...
	Type            *string `json:"type" binding:"omitempty,oneof=Corporations NonProfit Cooperative 'Sole Proprietorship'"` // Corporations | NonProfit | Cooperative | Sole Proprietorship
}
